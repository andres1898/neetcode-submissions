...
hero_health = super_hero.get_health()
hero_power_level = super_hero.get_power_level()
print(f"{super_hero.name} has {hero_health} health and {hero_power_level} power level")
